<template>
  <div class="app-container">
    <el-form :model="queryParams" ref="queryForm" :inline="true" v-show="showSearch">
      <el-form-item label="item name" prop="menuName">
        <el-input
      ...
      <el-form-item label="status" prop="status">
        <el-select v-model="queryParams.status" placeholder="item status" clearable size="small">
          <el-option
    ...
    >
      <el-table-column prop="menuName" label="item name" :show-overflow-tooltip="true" width="160"></el-table-column>
      ...
      <el-table-column label="Creat time" align="center" prop="createTime">
        <template slot-scope="scope">
...
export default {
  ...
  methods: {
    ...
    /** 删除按钮操作 */
    handleDelete(row) {
      this.$confirm('Are you sure to delete the item name as"' + row.menuName + '?', "WARNING", {
